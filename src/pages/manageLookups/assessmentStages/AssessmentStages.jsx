						...
						<div class="row align-items-center">
							<div class="col">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active">Assessment Stages</li>
								</ul>
							</div>
							<div class="col-auto float-end ms-auto">
								<a href="#" data-bs-toggle="modal" data-bs-target="#add_employee" class="btn add-btn"> Add Assessment Stages</a>
							</div>
						</div>
					</div>
					{/* <!-- /Page Header --> */}
									...
									<div class="row">
										<div class="col-sm-12">
											<div class="form-group">
												<label>Assessment Stage <span class="text-danger">*</span></label>
							...
							<div class="modal-body">
								<form>
									<div class="row">
										<div class="col-sm-12">
											<div class="form-group">
												<label>Assessment Stages <span class="text-danger">*</span></label>
												<input class="form-control" type="text"/>
											</div>
										</div>
										<div class="col-sm-12">
